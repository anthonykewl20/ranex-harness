...
import { EventSequenceTable, EventTable } from "@ranex/core/event/sql"
...
import { WorkspaceEvent } from "@ranex/schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        RANEX_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        RANEX_WORKSPACE_ID: config.id,
        RANEX_EXPERIMENTAL_WORKSPACES: "true",
