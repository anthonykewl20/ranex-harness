...
import { PtyProtocol } from "@ranex/core/pty/protocol"
import { PtyID } from "@ranex/core/pty/schema"
import { PtyTicket } from "@ranex/core/pty/ticket"
import { LocationServiceMap, locationServiceMapLayer } from "@ranex/core/location-services"
import { Location } from "@ranex/core/location"
import { AbsolutePath } from "@ranex/core/schema"
import { Shell } from "@ranex/core/shell"
  ...
  Effect.gen(function* () {
    ...
    return handlers.handleRaw(
      ...
      Effect.fn("PtyHttpApi.connect")(function* (ctx: {
        ...
        const originAllowed =
          validOrigin(ctx.request, cors) && (!ctx.request.headers.host || isAllowedHost(ctx.request.headers.host, cors))
        if (ticket) {
