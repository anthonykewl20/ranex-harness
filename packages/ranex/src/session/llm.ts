...
import { llmClient } from "@ranex/core/effect/app-node-platform"
...
import type { LLMEvent } from "@ranex/llm"
import { LLMClient } from "@ranex/llm/route"
import type { LLMClientService } from "@ranex/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @ranex/llm. It
