import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@ranex/llm"
...
// Move this extraction into @ranex/llm when Copilot is handled by the native runtime.
