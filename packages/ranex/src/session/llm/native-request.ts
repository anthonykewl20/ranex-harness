import type { JsonSchema, LLMRequest, ProviderMetadata } from "@ranex/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@ranex/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @ranex/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
