...
import { ProjectDirectoryTable, ProjectTable } from "@ranex/core/project/sql"
import { ProjectDirectories } from "@ranex/core/project/directories"
...
import { which } from "@ranex/core/util/which"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.RANEX_FAKE_VCS)
