...
import type { LLMError } from "@ranex/llm"
...
export interface Interface {
  ...
  /** Reconciles tools stranded `running` by a prior crash without scheduling a provider turn. */
  readonly reconcile: (sessionID: SessionSchema.ID) => Effect.Effect<void, RunError>
}
