...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.RANEX_WEBSEARCH_PROVIDER === "exa" || process.env.RANEX_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.RANEX_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("RANEX_EXPERIMENTAL") || truthy("RANEX_ENABLE_EXA") || truthy("RANEX_EXPERIMENTAL_EXA"),
    enableParallel: truthy("RANEX_ENABLE_PARALLEL") || truthy("RANEX_EXPERIMENTAL_PARALLEL"),
