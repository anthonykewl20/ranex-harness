...
import { Durable } from "@ranex/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@ranex/schema/event").ID
export type { Data, Definition, Payload } from "@ranex/schema/event"
