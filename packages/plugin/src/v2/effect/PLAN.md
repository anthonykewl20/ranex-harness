...
- Effect plugins import `@ranex/plugin/v2/effect`, not `@ranex/core`.
- Public domain values use generated `@ranex/sdk` types.
...
- Define `PluginHost` domain capabilities in `@ranex/plugin/v2/effect`.
