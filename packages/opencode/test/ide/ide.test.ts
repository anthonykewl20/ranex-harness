...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders RANEX_CALLER", () => {
    process.env["RANEX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode RANEX_CALLER", () => {
    process.env["RANEX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown RANEX_CALLER", () => {
    process.env["RANEX_CALLER"] = "unknown"
