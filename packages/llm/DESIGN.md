...
> current private `@ranex/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@ranex/ai`
...
import { LLM } from "@ranex/ai"
import { OpenAI } from "@ranex/ai/providers/openai"
...
```ts
import { LLM } from "@ranex/ai/promise"
import { OpenAI } from "@ranex/ai/providers/openai"
...
```ts
import { LLMSchema } from "@ranex/ai/schema"
...
```ts
import { Provider, Protocol } from "@ranex/ai/provider"
...
@ranex/ai/providers/openai
@ranex/ai/providers/anthropic
@ranex/ai/providers/google
...
```
