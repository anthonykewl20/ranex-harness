...
- Canonical tagged tool file sources in `@ranex/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `RANEX_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
