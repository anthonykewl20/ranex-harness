...
1. Add `@ranex/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@ranex/effect-drizzle-sqlite` as a dependency of `packages/opencode`.
